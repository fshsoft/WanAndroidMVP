package com.fsh.android.mvp.contract.collect;
...
public class Contract {
    public interface ICollectModel {
        ...
        Observable<com.fsh.android.mvp.bean.collect.Collect> unCollect(int articleId, int originId);
    ...
    public interface ICollectView extends IBaseView {
        ...
        void onUnCollect(com.fsh.android.mvp.bean.collect.Collect collect, int articleId);
    }
