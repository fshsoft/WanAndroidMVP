...
import com.fsh.android.mvp.Custom.CustomDialog;
import com.fsh.android.mvp.Custom.loading.LoadingView;
import com.fsh.android.mvp.R;
import com.fsh.android.mvp.adapter.CollectAdaper;
...
import com.fsh.android.mvp.presenter.collect.CollectPresenter;
...
public class CollectActivity extends BaseActivity<Contract.ICollectView, CollectPresenter> implements Contract.ICollectView,
    ...
    @Override
    public void onUnCollect(com.fsh.android.mvp.bean.collect.Collect collect, int articleId) {
        if (collect != null) {
